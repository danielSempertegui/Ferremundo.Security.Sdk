...
public static class SecurityOAuthErrorCodes
{
    ...
    public const string ScopeInactive = "SECURITY_OAUTH_SCOPE_INACTIVE";
    public const string ScopeRequiredForPermission = "SECURITY_OAUTH_CLIENT_SCOPE_REQUIRED_FOR_PERMISSION";
    public const string ScopeHasAssignedPermissions = "SECURITY_OAUTH_CLIENT_SCOPE_HAS_ASSIGNED_PERMISSIONS";
}
